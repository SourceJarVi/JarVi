...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌯⁞[تحديثات البوت](t.me/UQXUQ) \n⌯⁞[قناه السورس](t.me/UQXUQ)')
end
...
send(msg.chat_id_,0," *⌯⁞العضو :* {["..data.first_name_.."](t.me/UQXUQ)}\n⌯⁞["..JarVi_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *⌯⁞عذرا ↫* {["..data.first_name_.."](t.me/UQXUQ)}\n*⌯⁞عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_,msg.id_,'⌯⁞شترك في قناة السورس اولآ @UQXUQ.') 
return false 
end 
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ JarVi\n\n[✫  JarVi ᴄʜᴀɴɴᴇʟ](http://t.me/UQXUQ)\n\n[✫  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/SourceJarVi)\n\n[✫  JarVi ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/nnzzz)\n\n[✫  ʙᴏᴛ JarVi](http://t.me/Jrvibot)" 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '✫ sᴏᴜʀᴄʀ JarVi',url="t.me/UQXUQ"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/UQXUQ&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--------------------------------------------------------------------------------------------------------------
