...
io.popen("cd library && wget https://raw.githubusercontent.com/SNAB-DEV/SNAB/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SNAB-DEV/Files_SNAB/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevSNABW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevSNABW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevSNABW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevSNABW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevSNABW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevSNABW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevSNABW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
SNAB_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
SNAB_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
SNAB_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
SNAB_Msg = 'امبروطور التفاعل' 
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@KXK_X")  
...
--------------------------------------------------------------------------------------------------------------
function SourceSNAB(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."SNAB1:List:Filter"..sl)
...
if not DevSNABW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevSNABW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,SNAB_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ✬' and DevSNABW(msg) then  
...
if text == 'تعطيل التواصل ✬' and DevSNABW(msg) then  
...
if text == 'تفعيل البوت الخدمي ✬' and DevSNABW(msg) then  
...
if text == 'تعطيل البوت الخدمي ✬' and DevSNABW(msg) then  
...
if text == 'ضع كليشه ستارت ✬' and DevSNABW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *✬︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ✬' and DevSNABW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *✬︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ✬' and DevSNABW(msg) then 
...
if text == 'تحديث السورس ✬' and DevSNABW(msg) then 
os.execute('rm -rf SNAB.lua')
os.execute('wget https://raw.githubusercontent.com/SNAB-DEV/SNAB/main/SNAB.lua')
send(msg.chat_id_, msg.id_,' *✬︙تم تحديث السورس* \n*✬︙لديك اخر اصدار لسورس سناب*\n*✬︙الاصدار » { 2.8v}*')
dofile('SNAB.lua')  
end
if text == 'الاصدار ✬' and DevSNABW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *✬︙اصدار سورس سناب* \n*✬︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ✬' and DevSNABW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✬︙[تحديثات البوت](t.me/LZZZ5) \n✬︙[قناه السورس](t.me/rrrrwv)')
end
if text == "ضع اسم للبوت ✬" and DevSNABW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *✬︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ✬' and DevSNABW(msg) then 
...
if text == 'المشتركين ✬' and DevSNABW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✬︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ✬' and DevSNABW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✬︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ✬") and DevSNABW(msg) then
...
if text == ("قائمه العام ✬") and DevSNABW(msg) then
...
if text == ("قائمه الكتم العام ✬") and DevSNABW(msg) then
...
if text=="اذاعه خاص ✬" and msg.reply_to_message_id_ == 0 and DevSNABW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✬︙ارسل الان اذاعتك؟* \n*✬︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ✬" and msg.reply_to_message_id_ == 0 and DevSNABW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✬︙ارسل الان اذاعتك؟* \n*✬︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ✬" and msg.reply_to_message_id_ == 0 and DevSNABW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✬︙ارسل الان اذاعتك؟* \n*✬︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ✬" and msg.reply_to_message_id_ == 0  and DevSNABW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✬︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ✬" and msg.reply_to_message_id_ == 0  and DevSNABW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✬︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ✬' and DevSNABW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ✬" and DevSNABW(msg) then
...
if text == "تنظيف الكروبات ✬" and DevSNABW(msg) then 
...
send(msg.chat_id_, msg.id_,'*✬︙عدد الكروبات الان » { '..#group..' }'..SNABk..''..SNAB..'*\n*✬︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevSNABW(msg) then
...
usertext = '*\n ✬︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'rrrrwv')..')'
status  = '\n *✬︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevSNABW(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *✬︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'rrrrwv')..')'
status  = '\n*✬︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevSNABW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevSNABW(msg) then
...
local SNAB1_Msg = database:get(bot_id.."SNAB1:Add:Filter:Rp2"..text..msg.chat_id_)   
if SNAB1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✬︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'rrrrwv')..') \n ✬︙'..SNAB1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if SNAB_Msg and not Special(msg) then  
local SNAB_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if SNAB_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✬︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✬︙["..SNAB_Msg.."] \n")
else
send(msg.chat_id_,0," *✬︙العضو :* {["..data.first_name_.."](T.ME/rrrrwv)}\n✬︙["..SNAB_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *✬︙عذرا ↫* {["..data.first_name_.."](T.ME/rrrrwv)}\n*✬︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevSNABW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevSNABW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevSNABW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✬︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevSNABW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✬︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ✬" and DevSNABW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *✬︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✬$") and DevSNABW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✬︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✬" and DevSNABW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ✬" and DevSNABW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *✬︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ✬" and DevSNABW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."SNAB:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."SNAB:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_SNAB = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_SNAB then 
names_SNAB = database:smembers(bot_id.."SNAB:blocname"..msg.chat_id_) or ""
if names_SNAB and names_SNAB[1] then 
for i=1,#names_SNAB do 
if name_SNAB:match("(.*)("..names_SNAB[i]..")(.*)") then 
...
database:set(bot_id.."SNAB:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."SNAB:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."SNAB:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."SNAB:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."SNAB:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_SNABa_new(SNAB1,SNAB2)
if SNAB2 and SNAB2.first_name_ then 
if SNAB2.first_name_:match("(.*)"..database:get(bot_id.."SNAB:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."SNAB:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local SNAB_nnn = database:get(bot_id.."SNAB:nump"..msg.chat_id_) or 5
local SNAB_nnn2 = database:get(bot_id.."SNAB:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(SNAB_nnn2) == tonumber(SNAB_nnn) or tonumber(SNAB_nnn2) > tonumber(SNAB_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."SNAB:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✬︙عزيزي >>["..SNAB2.username_.."](https://t.me/"..(SNAB2.username_ or "rrrrwv")..")\n✬︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."SNAB:teh"..msg.chat_id_).."} بجانب اسمك\n✬︙عدد المحاولات المتبقيه {"..(tonumber(SNAB_nnn) - tonumber(SNAB_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_SNABa_new)
end
end
...
local SNABChengName = database:get(bot_id.."SNAB:Cheng:Name"..data.id_)
if not data.first_name_ then 
if SNABChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..SNABChengName..']')
database:del(bot_id.."SNAB:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if SNABChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."SNAB:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local SNABChengUserName = database:get(bot_id.."SNAB:Cheng:UserName"..data.id_)
if not data.username_ then 
if SNABChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..SNABChengUserName..']')
database:del(bot_id.."SNAB:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if SNABChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."SNAB:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local SNABChengPhoto = database:get(bot_id.."SNAB:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if SNABChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."SNAB:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if SNABChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."SNAB:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ ѕɴᴀʙ\n\n[✬  ѕɴᴀʙ ᴄʜᴀɴɴᴇʟ](http://t.me/rrrrwv)\n\n[✬  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/LZZZ5)\n\n[✬  ѕɴᴀʙ ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/KXK_X)\n\n[✬  ʙᴏᴛ ѕɴᴀʙ](http://t.me/GGY6FBOT)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✬ sᴏᴜʀᴄʀ ѕɴᴀʙ',url="t.me/rrrrwv"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/rrrrwv&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
if text == 'رفع نسخه الاحتياطيه' and DevSNABW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
send(msg.chat_id_, msg.id_, '*✬︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'rrrrwv')..') \n*✬︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✬︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'rrrrwv')..') \n*✬︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevSNABW(msg) then
dofile('SNAB.lua')  
send(msg.chat_id_, msg.id_, ' *✬︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevSNABW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevSNABW(msg) then  
function start_function(extra, result, success)
if SNABSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevSNABW(msg) then  
...
if SNABSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*✬︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevSNABW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if SNABSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*✬︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevSNABW(msg) then  
function start_function(extra, result, success)
if SNABSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*✬︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevSNABW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevSNABW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if SNABSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*✬︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevSNABW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevSNABW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevSNABW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevSNABW(msg) then
...
if text == 'الملفات' and DevSNABW(msg) then
t = ' *✬︙ملفات السورس سناب ↓*\n*•━━━━━━ 𝙎𝘽 ━━━━━━━•* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if DevSNABW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SNAB-DEV/Files_SNAB/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *✬︙اهلا بك في متجر ملفات سناب*\n*✬︙ملفات السورس ↓*\n*•━━━━━━ 𝙎𝘽 ━━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━ 𝙎𝘽 ━━━━━━━•*\n *✬︙علامة تعني { ✓ } ملف مفعل*\n *✬︙علامة تعني { ✘ } ملف معطل*\n *✬︙قناة سورس سناب ↓*\n".." *✬︙*[اضغط هنا لدخول](t.me/rrrrwv) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevSNABW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/SNAB-DEV/Files_SNAB/main/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevSNABW(msg) then
...
if text == "مسح الملفات" and DevSNABW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *✬︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevSNABW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevSNABW(msg) then  
function start_function(extra, result, success)
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *✬︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'rrrrwv')..')'
status  = '\n*✬︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *✬︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✬︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'rrrrwv')..')'
...
database:set(bot_id.."SNAB1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."SNAB1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *✬︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."SNAB1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."SNAB1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."SNAB1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."SNAB1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *✬︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."SNAB1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."SNAB1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."SNAB1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."SNAB1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *✬︙ارسل الكلمه الان*")  
database:set(bot_id.."SNAB1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."SNAB1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."SNAB1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SNAB1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."SNAB1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."SNAB1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."SNAB1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SNAB1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."SNAB1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevSNABW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *✬︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevSNABW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *✬︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'rrrrwv')..')'..'\n*✬︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevSNABW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevSNABW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..SNAB_Msg[math.random(#SNAB_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevSNABW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,SNAB)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ 𝙎𝘽 ━━━━━━━•*\n"
x = 0
local list = SNAB.members_
for k, v in pairs(list) do
x = x + 1
...
if SNABSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevSNABW(msg) then 
...
if text == ("ردود المطور") and DevSNABW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ✬︙قائمة ردود المطور \n*•━━━━━━ 𝙎𝘽 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevSNABW(msg) then    
send(msg.chat_id_, msg.id_,' *✬︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevSNABW(msg) then    
...
if text == 'تفعيل المغادره' and DevSNABW(msg) then   
...
if text == 'تعطيل المغادره' and DevSNABW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*✬︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'LZZZ5')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'rrrrwv')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
SNABdx(msg.chat_id_, msg.id_, ' *✬︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*✬︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*✬︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*✬︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevSNABW(msg) then
...
{{text = '.⌁︙SNAP TEAM', url="t.me/LZZZ5"}},
{{text = 'مطور السورس', url="t.me/KXK_X"}},
}
...
inline = {
{{text = 'sᴏᴜʀᴄʀ ѕɴᴀʙ',url='http://t.me/LZZZ5'}},
}
...
SNAB = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(SNAB)
...
------------------------------------------------------------------------
local SNABAbot = database:get(bot_id.."SNAB1:Add:Filter:Rp2"..text..result.chat_id_)   
if SNABAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✬︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✬︙["..SNABAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local SNAB1_Msg = database:get(bot_id.."SNAB1:Add:Filter:Rp2"..text..result.chat_id_)   
if SNAB1_Msg then
send(msg.chat_id_, msg.id_," ✬︙"..SNAB1_Msg)
